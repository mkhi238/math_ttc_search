...
if __name__ == "__main__":
  ...
  #GENERATE SAMPLES  
  samples = create_sampling_parameters(n = N, temperature = TEMPRATURE, max_tokens = MAX_TOKENS)
  ...
  results_df.to_csv('/mnt/d/math_ttc_search/results/best_of_n_MATH.csv', index=False)
